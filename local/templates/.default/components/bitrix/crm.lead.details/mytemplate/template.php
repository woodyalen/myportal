...
?>
    <div class="ui-btn-double ui-btn-primary">
        <button id="toolbar_lead_details_5_test" class="ui-btn-main">Что то еще</button>
        <button id="toolbar_lead_details_5_test" class="ui-btn-extra"></button>
    </div>
<?
$this->EndViewTarget();
...
$editorContext = [ 'PARAMS' => $arResult[ 'CONTEXT_PARAMS' ] ];
